  ...
  return (
    <section className="relative overflow-hidden bg-slate-950 pt-32 pb-20">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/* Status */}
        <span className="inline-flex items-center gap-2 rounded-full bg-red-600 px-5 py-2 text-sm font-semibold text-white">
          <BadgeCheck size={16} />
          Available
        </span>
        ...
        <div className="mt-6 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-lg leading-relaxed text-slate-400">
              Premium highway tractor designed for long-haul operations,
              offering reliability, efficiency, and driver comfort.
            </p>
          </div>
